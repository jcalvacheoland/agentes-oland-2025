    ...
    <div className="min-h-screen grid lg:grid-cols-2 font-outfit">
      ...
      <div className="relative hidden lg:flex flex-col items-center justify-center p-8 bg-azul-oland-100 text-white">
        <div className="max-w-md mx-auto text-center space-y-6">
          ...
          <h2 className="text-4xl font-medium ">Tu portal de cotizaciones</h2>
          <p className="text-md text-white/80">
            Accede a las mejores ofertas y gestiona tus cotizaciones de manera
            rápida y sencilla con nuestra plataforma dedicada a agentes de
            seguros.
          </p>
        </div>
      </div>
